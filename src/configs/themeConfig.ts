...
const themeConfig: Config = {
  templateName: 'ReyMani',
  settingsCookieName: 'reymani-settings',
  modeStorageKey: 'reymani-theme-mode', // Clave para almacenar el modo en localStorage
  mode: 'dark', // 'light', 'dark' - valor predeterminado
